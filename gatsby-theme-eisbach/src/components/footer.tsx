...
const Footer = () => {
  const { showThemeAuthor } = useEisbachConfig()
        ...
        >
          {isDark ? (
            <img
              width="30"
              height="30"
              src="https://img.vinckr.de/gatsby/logo_v2-light_w30.png"
              alt="vinckr Logo"
            />
          ) : (
            <img width="30" height="30" src="https://img.vinckr.de/gatsby/logo_v2_w30.png" alt="vinckr Logo" />
          )}
          {` `}
          <Link
            aria-label="Link to the theme's GitHub repository"
            sx={{ ml: 2 }}
            href="https://github.com/vinckr/gatsby-themes/tree/main/themes/gatsby-theme-eisbach"
          >
            Theme
          </Link>
          <div sx={{ mx: 1 }}>by</div>
          ...
          <Link
            ...
            href="https://www.vinckr.de?utm_source=eisbach&utm_medium=Theme"
          >
            vinckr
          </Link>
        </Container>
