      ...
      <Layout>
        ...
        <Container>
          <Themed.p>
            ...
            {` `}
            <br />
            Thanks for using <b>@vinckr/gatsby-theme-eisbach</b>. You currently don't have any content in your{` `}
            <i>projects</i> folder - that's why this page displays a placeholder text. Head over to the{` `}
            <Themed.a href="https://github.com/vinckr/gatsby-themes/tree/main/themes/gatsby-theme-eisbach">
              README
            </Themed.a>
            {` `}
