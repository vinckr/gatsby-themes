...
exports.createSchemaCustomization = ({ actions, schema }, themeOptions) => {
  ...
  createTypes(`
    ...
    type EisbachConfig implements Node {
      name: String
      location: String
...
exports.sourceNodes = (
  { actions, createContentDigest },
  {
    ...
    location = `Germany`,
    socialMedia = [
      { title: `Twitter`, href: `https://twitter.com/vinckr_de` },
      { title: `Homepage`, href: `https://www.vinckr.de?utm_source=eisbach&utm_medium=Theme` },
    ],
  ...
  createNode({
    ...EisbachConfig,
    id: `@vinckr/gatsby-theme-eisbach-core-config`,
    parent: null,
    children: [],
    internal: {
      type: `EisbachConfig`,
      contentDigest: createContentDigest(EisbachConfig),
      content: JSON.stringify(EisbachConfig),
      description: `Options for @vinckr/gatsby-theme-eisbach-core`,
    },
  })
}
